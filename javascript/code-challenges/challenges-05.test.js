...
const addValues = (arr) => {
  ...
  const addPurchases = (arr) => {
    //   let added = arr.reduce((accumulator, price, idx) => {
    //     accumulator[price.purchasePrice] = ;
    //     return accumulator;
    //   }0);
    //   return added;
    // };
    ...
    const countNumberOfElements = (arr) => {
      // let nums = arr.reduce( function(accumulator,value,idx){
